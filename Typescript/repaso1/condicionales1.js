...
function continent(country) {
    if (country === 'Italia' || country === 'Francia' || country === 'Dinamarca') {
        console.log("El pa\u00EDs ".concat(country, " est\u00E1 en Europa"));
    }
    if (country === 'Japón' || country === 'China' || country === 'India') {
        console.log("El pa\u00EDs ".concat(country, " est\u00E1 en Asia"));
    }
    if (country === 'Colombia' || country === 'Brasil' || country === 'Ecuador') {
        console.log("El pa\u00EDs ".concat(country, " est\u00E1 en Am\u00E9rica del Sur"));
    }
    if (country === 'Estados Unidos' || country === 'Canadá' || country === 'Mexico') {
        console.log("El pa\u00EDs ".concat(country, " est\u00E1 en Am\u00E9rica del Norte"));
    }
    if (country === 'Nueva Zelanda' || country === 'Australia' || country === 'Samoa') {
        console.log("El pa\u00EDs ".concat(country, " est\u00E1 en Ocean\u00EDa"));
    }
}
